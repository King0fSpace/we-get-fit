    ...
    [query findObjectsInBackgroundWithBlock:^(NSArray *objects, NSError *error)
     {
         if (error == nil)
         {
             if ([objects count] == 0)
             {
                 ...
                 //Save user1's objectId to the sender_objectId field
                 message[@"sender_objectId"] = user1.objectId;
                 
                 //Save user2's objectId to the receiver_objectId field
                 message[@"receiver_objectId"] = user2.objectId;
