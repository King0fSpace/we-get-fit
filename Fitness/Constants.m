...
NSString *const kPAPUserAttributesIsFriendedByCurrentUserKey    = @"isFriendedByCurrentUser";
NSString *const kPAPUserAttributesIsSavedToListByCurrentUserKey = @"isSavedToListByCurrentUser";
