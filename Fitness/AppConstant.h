...
#define		PF_USER_FULLNAME					@"full_name"				//	String
#define		PF_USER_FULLNAME_LOWER				@"fullname_lower"		//	String
#define		PF_USER_FACEBOOKID					@"facebookId"			//	String
#define		PF_USER_PICTURE						@"profile_photo"		//	File
#define		PF_USER_THUMBNAIL					@"profile_photo_thumbnail"  //	File
...
#define		PF_CHAT_PICTURE						@"profile_photo"		//	File
