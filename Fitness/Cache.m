...
- (NSArray *)likersForPhoto:(PFObject *)photo {
    NSLog (@"likersForPhoto:(PFObject *)photo");
    NSDictionary *attributes = [self attributesForPhoto:photo];
    if (attributes) {
        NSLog (@"likers count = %li", [[attributes objectForKey:kPAPPhotoAttributesLikersKey] count]);
...
- (void)incrementLikerCountForPhoto:(PFObject *)photo {
    NSLog (@"incrementLikerCountForPhoto:(PFObject *)photo");
    NSNumber *likerCount = [NSNumber numberWithInt:[[self likeCountForPhoto:photo] intValue] + 1];
    NSLog (@"likerCount from incrementLikerCountForPhoto:(PFObject *)photo = %li", [likerCount integerValue]);
    NSMutableDictionary *attributes = [NSMutableDictionary dictionaryWithDictionary:[self attributesForPhoto:photo]];
...
- (void)setFriendStatus:(BOOL)friending user:(PFUser *)user {
    NSMutableDictionary *attributes = [NSMutableDictionary dictionaryWithDictionary:[self attributesForUser:user]];
    [attributes setObject:[NSNumber numberWithBool:friending] forKey:kPAPUserAttributesIsFriendedByCurrentUserKey];
    [self setAttributes:attributes forUser:user];
}

- (void)setSavedToList:(NSString*)listName user:(PFUser *)user{
    NSMutableDictionary *attributes = [NSMutableDictionary dictionaryWithDictionary:[self attributesForUser:user]];
    [attributes setObject:[NSString stringWithString:listName] forKey:kPAPUserAttributesIsSavedToListByCurrentUserKey];
    [self setAttributes:attributes forUser:user];
}
